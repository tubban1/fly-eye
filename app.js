...
Object.assign(dict.en,{
  ...
  graphReady:'READY',graphLoading:'GRAPH LOADING',fastGraph:'FAST GRAPH',graphErrorBadge:'GRAPH ERROR',scoreRejected:'Round was too fast to validate; leaderboard still loaded.',playerName:'PLAYER NAME',playerNamePlaceholder:'Choose a public name',saveName:'SAVE',namePublic:'Shown publicly on the leaderboard. Your browser keeps your player ID.',nameSaved:'Name saved',nameInvalid:'Enter a name up to 24 characters',
...
Object.assign(dict.zh,{
  ...
  graphReady:'已就绪',graphLoading:'图加载中',fastGraph:'快速图',graphErrorBadge:'连接图错误',scoreRejected:'本轮速度过快，成绩未计入；排行榜仍可查看。',playerName:'玩家昵称',playerNamePlaceholder:'输入公开昵称',saveName:'保存',namePublic:'昵称会公开显示在排行榜；浏览器会继续保存你的玩家 ID。',nameSaved:'昵称已保存',nameInvalid:'请输入不超过 24 个字符的昵称',
